...
#define VDRAM		(0xFFFFFFFF70000000ULL)	/* 0x70000000 - 0xF0000000 (VZ RAM, max 2GB) */
#define	KTZERO		(VDRAM + 0x100000)	/* 0x70100000 - kernel text start */

#define PHYSIO		0x10000000	/* GICD 0x10000000, GICR 0x10010000 */
#define PHYSIOEND	0x20070000	/* PL031 0x20050000, PL061 0x20060000 */

#define	VIRTIO		(KZERO + PHYSIO)	/* device window keeps PA = VA-KZERO */

#define	KZERO		(0xFFFFFFFF00000000ULL)	/* kernel address space */

#define VMAP		(0xFFFFFFFFF0000000ULL)	/* top 256MB: vmap arena (ECAM, BARs) */
...
#define CONFADDR	(VDRAM + 0x10000)	/* 0x70010000 */

#define BOOTARGS	((char*)CONFADDR)
#define BOOTARGSLEN	0x10000

#define	REBOOTADDR	(VDRAM-KZERO + 0x20000)	/* 0x70020000 */
